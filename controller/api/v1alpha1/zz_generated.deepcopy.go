...
func (in *RulesOptsSpec) DeepCopyInto(out *RulesOptsSpec) {
	*out = *in
	...
	if in.MaintainExecutionOrder != nil {
		in, out := &in.MaintainExecutionOrder, &out.MaintainExecutionOrder
		*out = new(bool)
		**out = **in
	}
	...
	if in.RetainFailedEventsCount != nil {
		in, out := &in.RetainFailedEventsCount, &out.RetainFailedEventsCount
		*out = new(int)
		**out = **in
	}
	if in.RetainSuccessfulEventsCount != nil {
		in, out := &in.RetainSuccessfulEventsCount, &out.RetainSuccessfulEventsCount
		*out = new(int)
		**out = **in
	}
}
